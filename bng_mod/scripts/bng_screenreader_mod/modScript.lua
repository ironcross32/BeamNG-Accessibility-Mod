...
log('I', 'bng_screenreader_mod', 'modScript.lua executed: vehicleScanner, beamtelAI, vehicleSlots, cameraInfo, obstacleDetector, nodeGrabberAccessible, clickspotAccessible, vehicleSpawnerAccessible, roadDetector, uiToggle loaded.')
